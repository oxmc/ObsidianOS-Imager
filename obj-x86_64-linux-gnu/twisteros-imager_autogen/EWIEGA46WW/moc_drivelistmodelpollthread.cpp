...
void DriveListModelPollThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        DriveListModelPollThread *_t = static_cast<DriveListModelPollThread *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject DriveListModelPollThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_DriveListModelPollThread.data,
      qt_meta_data_DriveListModelPollThread,  qt_static_metacall, nullptr, nullptr}
};
