...
/* Repository URL */
#define OSLIST_URL                        "https://oxmc.github.io/files/rpi/apps/imager-rpi/ObsidianOS_image_list_v2.json"

/* Time synchronization URL (only used on eglfs QPA platform, URL must be HTTP) */
#define TIME_URL                          "https://oxmc.github.io/files/rpi/apps/imager-rpi/ObsidianOS_image_list_v2.json?time_synchronization"
