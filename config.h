...
/* Repository URL */
#define OSLIST_URL                        "https://oxmc.github.io/ObsidianOS/apt/ObsidianOS_image_list_vs.json"

/* Time synchronization URL (only used on eglfs QPA platform, URL must be HTTP) */
#define TIME_URL                          "http://oxmc.github.io/ObsidianOS/apt/ObsidianOS_image_list_vs.json?time_synchronization"
